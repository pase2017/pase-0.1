...
HYPRE_Int
hypre_LOBPCGSolve( HYPRE_Int num_lock,
	           void *vdata, 
...
HYPRE_Int 
HYPRE_LOBPCGSolve( HYPRE_Int num_lock, HYPRE_Solver solver, mv_MultiVectorPtr con, 
		   mv_MultiVectorPtr vec, HYPRE_Real* val )
{
   return( hypre_LOBPCGSolve( num_lock, (void *) solver, con, vec, val ) );
}
