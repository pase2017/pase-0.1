...
SLEPC_EPS="-eigen_max_iter 150"
SLEPC_ST=
SLEPC_KSP="-cg_max_iter 1000"
SLEPC_EPS_VAR="-eigen_tol 1e-4 -cg_rate 1e-1" 
SLEPC_LOG=
NP="20"

IF_PRINT="-print_eval 1 -print_cg 0 -if_giveninit 0"
...
mpiexec -n ${NP} ${EXEC} > ../output/guangji/20180109_guangji_nev10.${NP}.output 2>&1 
