...
//   int time_index; 
   ...
   HYPRE_BoomerAMGSetCoarsenType(amg_solver, 7);
   ...
   HYPRE_BoomerAMGSetCoarsenType(precond, 7);
...
//	 hypre_ClearTiming();
   ...
   printf ( "-----\n" );
   /* eigenvectors - create a multivector */
   mv_MultiVectorPtr eigenvectors = mv_MultiVectorCreateFromSampleVector(interpreter, block_size, U_array[0]);
   /* eigenvectors - get a pointer */
   {
      mv_TempMultiVector* tmp = 
	 (mv_TempMultiVector*) mv_MultiVectorGetData(eigenvectors);
